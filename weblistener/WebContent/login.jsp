...
function changeImg(){
	document.getElementById("img").src="/weblistener/checkCode?time="+ new Date().getTime();
}
</script>
<title>LOGIN</title>
</head>
<body>
	<form action="/weblistener/login" method="post">
		<h1>Login</h1>
		<%
			String wrong = "";
		...
		<table border="3px" width="600" style="color: blue;">
			...
			<tr>
				...
				<img id = "img" src="/weblistener/checkCode" />
